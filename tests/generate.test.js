...
function createGenerateTests(name, test) {
  ...
  (test.skip || test.skipRoundtrip ? it.skip : it)(
    name + " (round-trip)",
    () => {
...
describe("generate", () => {
  ...
  it("should throws on unknown node type", () =>
    assert.throws(() => generate({ type: "xxx" }), /Unknown node type/));
  ...
  describe("sourceMap", () => {
    ...
    it("complex CSS", () => {
      ...
      assert.strictEqual(
        result.map.toString(),
        '{"version":3,"sources":["test.css"],"names":[],"mappings":"AAAA,E,CAAK,a,CAAkB,E,CAAK,a,CAAgB,U,CAAe,WAAa,E,CAAK,W"}',
      );
    });
  });
