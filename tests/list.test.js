...
function createIteratorTests(list, method, items, until, retValue) {
  ...
  it("iterate", () => {
    ...
    assert.deepStrictEqual(
      collector.states,
      items.map((item) => getIteratorState(list, item.data, item, list)),
    );
  });
  ...
  it("iterate with thisArg", () => {
    ...
    assert.deepStrictEqual(
      collector.states,
      items.map((item) => getIteratorState(thisArg, item.data, item, list)),
    );
  });
...
function createIteratorWithModificationTests(
  list,
  method,
  items,
  until,
  ...
  it("insert items on iterate", () => {
    ...
    assert.deepStrictEqual(
      inserted,
      items.reduce((res, item, idx) => res.concat(item.data, "ins" + idx), []),
    );
...
describe("List", () => {
  ...
  describe("#forEach()", () => {
    ...
    createIteratorTests(iterateList, "forEach", [
      iterateList.head,
      iterateList.tail,
    ]);
    createIteratorWithModificationTests(iterateList, "forEach", [
      iterateList.head,
      iterateList.tail,
    ]);
  });
  ...
  describe("#forEachRight()", () => {
    const iterateList = new List().fromArray([foo, bar]);
    createIteratorTests(iterateList, "forEachRight", [
      iterateList.tail,
      iterateList.head,
    ]);
    createIteratorWithModificationTests(iterateList, "forEachRight", [
      iterateList.tail,
      iterateList.head,
    ]);
  });
  ...
  describe("#nextUntil()", () => {
    ...
    createIteratorTests(
      iterateList,
      "nextUntil",
      [iterateList.head, iterateList.tail],
      iterateList.head,
    );
    createIteratorWithModificationTests(
      iterateList,
      "nextUntil",
      [iterateList.head, iterateList.tail],
      iterateList.head,
  ...
  describe("#prevUntil()", () => {
    ...
    createIteratorTests(
      iterateList,
      "prevUntil",
      [iterateList.tail, iterateList.head],
      iterateList.tail,
    );
    createIteratorWithModificationTests(
      iterateList,
  ...
  describe("#some()", () => {
    ...
    const iterateList = new List().fromArray([foo, bar]);
    createIteratorTests(iterateList, "some", [
      iterateList.head,
      iterateList.tail,
    ]);
  });
  ...
  describe("#map()", () => {
    ...
    const iterateList = new List().fromArray([foo, bar]);
    createIteratorTests(iterateList, "map", [
      iterateList.head,
      iterateList.tail,
    ]);
  });
  ...
  describe("#filter()", () => {
    ...
    const iterateList = new List().fromArray([foo, bar]);
    createIteratorTests(iterateList, "filter", [
      iterateList.head,
      iterateList.tail,
    ]);
  });
  ...
  it("#prepend()", () => {
    ...
    assert.deepStrictEqual(toArray(list1.prepend(List.createItem(qux))), [
      qux,
      foo,
    ]);
    assert.deepStrictEqual(toArray(list2.prepend(List.createItem(qux))), [
      qux,
      foo,
      bar,
    ]);
  ...
  it("#append()", () => {
    ...
    assert.deepStrictEqual(toArray(list1.append(List.createItem(qux))), [
      foo,
      qux,
    ]);
    assert.deepStrictEqual(toArray(list2.append(List.createItem(qux))), [
      foo,
      bar,
      qux,
    ]);
